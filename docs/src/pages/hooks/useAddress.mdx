...
} from "../../components/UseAddressExamples";
...
| --------- | ---------------------- | --------- | ---------------------------------------------------- |
| `address` | `Address` _(optional)_ | -         | The Ethereum address to process and fetch data for.  |
| `chain`   | `Chain` _(optional)_   | `mainnet` | The blockchain network for ENS resolution and links. |

...
const Notification = ({
  ...
  return toast.custom(
    (t: Toast) => (
      <div
        className={`flex flex-row items-start justify-between max-w-sm shadow-center shadow-sui-primary bg-sui-primary-neutral p-4 transform-gpu relative transition-all duration-500 ease-in-out space-x-2
        ${

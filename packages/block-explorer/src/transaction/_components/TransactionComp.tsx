...
import { decodeTransactionData, getFunctionDetails, GenericContractsDeclaration } from "../../utils/decodeTxData";
  ...
  useEffect(() => {
    if (txHash && client) {
      const fetchTransaction = async () => {
        ...
        const transactionWithDecodedData = decodeTransactionData(tx, deployedContracts);

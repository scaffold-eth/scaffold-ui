...
type PageProps = {
  ...
  deployedContracts: GenericContractsDeclaration | null;
};
...
export const ContractTabs = ({ address, contractData, deployedContracts }: PageProps) => {
  const { blocks, transactionReceipts, currentPage, totalBlocks, setCurrentPage } = useFetchBlocks(deployedContracts);
